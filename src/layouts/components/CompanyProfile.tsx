...
import {Button,  TextField, FormControl, Autocomplete, TextareaAutosize, Divider,   ImageList, ImageListItem  } from '@mui/material'
        ...
        <FormControl> 
            <Grid xs={12} container  marginTop={'25px'}>
                <Grid container spacing={2} sx={{ mb:2 }}>
                    ...
                    <TextField id="companyName" label="companyName"   variant="outlined"  fullWidth sx={{ mb: 1 }}   
                    {...register("companyName")}/>
                    </Grid>
                    <Grid item md={6} xs={12}>
                    <TextField id="industryType" label="industryType"    variant="outlined" fullWidth sx={{ mb: 1 }} 
                    ...
                    <Grid item md={6} xs={12} >
                    <TextField id="postalcode" label="postalcode" variant="outlined" fullWidth sx={{ mb: 1 }}     {...register("postalCode")}/>
                    </Grid> 
                    <Grid item md={6} xs={12} >
                   ...
                   <StyledTextarea
                       ...
                       aria-label="empty textarea" placeholder="About" minRows={'3'}
                        title='tes'
                            {...register("about")}/>
                    ...
                    <Grid item md={2} xs={12} marginTop={'20px'} > 
                     ...
                     <Grid item md={3} xs={12}  marginTop={'20px'} >
                        <TextField size='small' id="usernamesosmed" label="Username" variant="outlined" fullWidth   sx={{ mb: 1 }}   {...register("usernamesosmed")}/>
                    </Grid> 
                    <Grid item md={2} xs={12 }  marginTop={'20px'} >
                    ...
                    <Grid item md={5} xs={12} > 
                            ...
                            <Typography variant="body1" >This is Galerry for the company.Please fill it.</Typography>
