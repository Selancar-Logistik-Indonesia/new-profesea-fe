          ...
          <Grid container columnSpacing={'1'} rowSpacing={'4'}>
            {/* <Grid item md={6} xs={12} >
                            <Autocomplete
                                ...
                                value={props.selectedItem.trainer}
                                options={Trainer}
            ...
            <Grid item md={12} xs={12}>
              <Autocomplete
                ...
                onChange={(event: any, newValue: TrainingCategory | null) =>
            ...
            <Grid item md={12} xs={12}>
              <DatePickerWrapper>
                <DatePicker
                  ...
                  customInput={
                    <TextField label='Expired Date' variant='outlined' fullWidth {...register('schedule')} />
                  }
                />
              </DatePickerWrapper>
            </Grid>
