...
const DialogAlumniEditProfilePicture = (props: IProps) => {
  ...
  const uploadPhotoProfile = (data: any) => {
    ...
    json.append('profilepicture', data)
    HttpClient.post(AppConfig.baseUrl + `/alumni/updatephoto/${props.id}`, json).then(
      ({ data }) => {
...
export default DialogAlumniEditProfilePicture
