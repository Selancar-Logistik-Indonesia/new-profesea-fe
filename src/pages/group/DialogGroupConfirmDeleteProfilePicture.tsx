...
const DialogGroupConfirmDeleteProfilePicture = (props: IProps) => {
  const [onLoading, setOnLoading] = useState(false)

  const handleProfileDelete = () => {
    HttpClient.del(AppConfig.baseUrl + `/group/${props.id}/delete-profile`).then(
      () => {
...
export default DialogGroupConfirmDeleteProfilePicture
