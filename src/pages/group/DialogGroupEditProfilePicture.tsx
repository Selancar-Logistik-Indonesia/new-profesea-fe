...
const DialogGroupEditProfilePicture = (props: IProps) => {
  ...
  const uploadPhotoProfile = (data: any) => {
    ...
    HttpClient.post(AppConfig.baseUrl + `/group/${props.id}/update-profile`, json).then(
      ({ data }) => {
...
export default DialogGroupEditProfilePicture
