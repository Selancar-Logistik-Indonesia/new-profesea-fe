        ...
        <>
            ...
            <Grid container sx={landingPageStyle.bannerHero}>
                <Grid item xs={12} xl={6} lg={8} md={12} pt={5} mt={20} mb={10} sx={{ maxWidth: { xs: '80%' }, px: { xs: 5, md: 10 } }}>
                    <Typography style={{ color: "#32487A"}} mt={1} fontWeight="800" fontSize={32} sx={{ maxWidth: { xs: '100%', whiteSpace: 'nowrap' }, px: { xs: 5, md: 5, whiteSpace: 'null' } }}>{t("landing_hero_title")}</Typography>
