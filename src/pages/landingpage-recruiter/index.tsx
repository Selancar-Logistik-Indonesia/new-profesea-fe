      ...
      >
        <Grid item xs={12} xl={6} lg={6} md={6} pt={10} sx={{ maxWidth: { xs: '90%' }, px: { xs: 5, md: 10 } }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', mt: 2 }}>
            <Box mb={4}>
              <div className='ag-courses_item'></div>
              ...
              <div className='ag-courses_item'>
                <a href='#' className='ag-courses-item_link'>
                  ...
                  <div className='ag-courses-item_title'>{t('landing_recruiter_title_1')}</div>
                </a>
              </div>
              ...
              <div className='ag-courses_item'>
                <a href='#' className='ag-courses-item_link'>
                  ...
                  <div className='ag-courses-item_title'>{t('landing_recruiter_title_2')}</div>
                </a>
              </div>
            </Box>
          </Box>
