...
const DialogGroupAddBanner = (props: IProps) => {
  ...
  useEffect(() => {
    if (croppedImage) {
      props.setBannerFile(croppedImage)
    }
  }, [croppedImage])
    ...
    <Dialog fullWidth open={props.visible} maxWidth='xl' scroll='body' TransitionComponent={Transition}>
      ...
      >
        ...
        <Box sx={{ mb: 6, textAlign: 'center' }}>
          ...
          <Typography variant='body2'> Add Group Banner here</Typography>
        </Box>
        <input
          accept='image/*'
...
export default DialogGroupAddBanner
