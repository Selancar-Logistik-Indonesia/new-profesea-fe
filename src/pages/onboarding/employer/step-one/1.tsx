...
import EmployerBasicInformationOne from 'src/layouts/components/onboarding/EmployerBasicInformationOne'
          ...
          <Box sx={{ mt: '32px', pb: '100px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <Typography sx={{ color: '#999', fontSize: 14, fontWeight: 400 }}>
                Lengkapi informasi dasar untuk membangun profil yang lebih lengkap dan profesional. Hal ini akan
                membantu membuat profil perusahaan Anda lebih terlihat dan mudah dijangkau oleh calon kandidat untuk
            ...
            <EmployerBasicInformationOne nextLink='/onboarding/employer/step-one/2' />
          </Box>
        </Box>
      </Grid>
      <Grid
