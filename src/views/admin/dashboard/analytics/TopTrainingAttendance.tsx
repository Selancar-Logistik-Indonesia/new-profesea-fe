...
const TopTrainingAttendance = () => {
  return (
      <DashboardProvider>
          <TopTrainingAttendanceApp />
      </DashboardProvider>
  )
}
...
const TopTrainingAttendanceApp = () => {
  const { statTopList } = useDashboard();

  useEffect(() => {
    statTopList({contribType:'training-attendance'});
  }, []);

  return (
    <DashboardContext.Consumer>
        {({ dataTopTraining, onLoading }) => {
...
export default TopTrainingAttendance
