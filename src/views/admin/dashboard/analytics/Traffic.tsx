...
const AnalyticsTrafficsByDay = () => {
  ...
  return (
    <Card>
      <CardHeader
        title='Traffics by Day'
        subheader='Total 248.5k Traffics'
      ...
      <CardContent sx={{ pt: { xs: `${theme.spacing(6)} !important`, md: `${theme.spacing(0)} !important` } }}>
        ...
        <Box sx={{ mt: 5, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
            <Typography sx={{ mb: 0.75, fontWeight: 600 }}>Most Traffics Day</Typography>
            <Typography variant='body2'>Total 62.4k Traffics on Thursday</Typography>
          </Box>
...
export default AnalyticsTrafficsByDay
