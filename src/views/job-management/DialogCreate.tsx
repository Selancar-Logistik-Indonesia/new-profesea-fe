...
const CreateJobCard = ({ link, label, description }: { link: string; label: string; description: string }) => {
  ...
  return (
    ...
    >
      <Icon className='hover' icon='ph:anchor' fontSize={28} color='#868686' />
...
const DialogCreate = (props: DialogProps) => {
  ...
  return (
    <Dialog maxWidth='sm' fullWidth={true} open={visible} onClose={onCloseClick}>
