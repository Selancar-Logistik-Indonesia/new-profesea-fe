...
const DiscoverView = () => {
    ...
    return (
        ...
        <Grid container justifyContent="center" sx={{ backgroundColor: '#eae6df' }} mt={0} pb={2} pt={10}>
            <Grid item xs={12}>
                <Box>
                    <Grid container sx={{
                        p: 4,
                        ...
                        <Grid container spacing={6}>
                            ...
                            <Grid item xs={12} sm={3}>
                                <Typography variant='h4' sx={{ mb: 5 }} color={"#32487A"} fontWeight="900" >{t("landing_lets_sail")}</Typography>
                                <Link href="/register">
