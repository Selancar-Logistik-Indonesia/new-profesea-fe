...
const DiscoverView = () => {
  ...
  return (
          ...
          >
            <Grid container spacing={6}>
              ...
              <Grid item xs={12} sm={5}>
                <Typography variant='h3' sx={{ mb: 5 }} color={'#FFFFFF'} fontWeight='800'>
                  {t('landing_lets_sail')}
                </Typography>
                <Link href='/register'>
                  <Button style={{ backgroundColor: '#ef6c00', color: 'white', marginRight: 10 }} variant='contained'>
    ...
    //     <Box sx={{ flexShrink: 1 }}>
    //         <Link href="/register">
    //             <Button style={{ backgroundColor: "#ef6c00", color: "white", marginRight: 10 }} variant="contained">{t('landing_join_now_1')}</Button>
    //         </Link>
    //     </Box>
    // </Box>
  )
