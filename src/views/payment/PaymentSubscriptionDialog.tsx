        ...
        <List>
          <Card>
            ...
            {selectedPlan.planType == 'pay-per-value' && (
              <Box sx={{ mx: 5, mb: 7 }}>
                <Typography variant='body1' mt={10} ml={5} mb={3} fontSize={14}>
                  Pilih Fitur
                </Typography>
                <Divider />
                <List>
            ...
            <Box mx={7} my={5} mt={3}>
              <FormControl fullWidth>
                <InputLabel sx={{ fontSize: 16 }} id='demo-simple-select-label'>
                  Durasi berlangganan
                </InputLabel>
                <Select
                  variant='standard'
            ...
            <Box mx={10} my={5}>
              ...
              {selectedPlan.planType == 'pay-per-value' ? (
                <Typography variant='body1' fontSize={24}>
                  {formatIDR(
                    parseFloat(
                      collect(packages.map(e => e.price * selectedDuration))
                        .sum()
                        .toString()
                    )
                  )}
                ...
                <Typography variant='body1' fontSize={24}>
                  {formatIDR(selectedPlan.price * selectedDuration)}
                </Typography>
              )}
            </Box>
          </Card>
