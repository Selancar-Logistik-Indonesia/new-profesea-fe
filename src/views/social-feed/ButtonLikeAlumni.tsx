...
const ButtonLikeAlumni = (props: { item: ButtonLikeParam, likeableType: string, variant?: 'no-icon' }) => {
    const { item, likeableType } = props;
    const { likeUnlikeFeed } = useAlumniFeed();
...
export default ButtonLikeAlumni;